...
<body>
	...
	<div class="search_wrap">
        <form action="{{url('admin/foods')}}" method="get">
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('admin/foods/'.$v->foods_id.'/edit')}}">修改</a>
...
//               
                $.post("{{url('admin/foods/')}}/"+id,{'_method':'delete','_token':"{{csrf_token()}}"},function(data){
//                   

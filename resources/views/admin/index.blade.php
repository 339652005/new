...
<!-- 
说明: 
data-href="{{url('admin/manager/create')}}" //路由
data-title="添加管理员"    //标题
 -->
				<ul>
					<li><a data-href="{{url('admin/manager/create')}}" data-title="添加管理员" href="javascript:;">添加管理员</a></li>

					<li><a data-href="{{url('admin/manager')}}" data-title="管理员列表" href="javascript:;">管理员列表</a></li>
			</ul>
		</dd>
	</dl>

		<dl id="menu-picture">
			<dt><i class="Hui-iconfont">&#xe613;</i> 用户操作<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="{{url('admin/user/create')}}" data-title="添加用户" href="javascript:;">添加用户</a></li>
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{url('admin/type/create')}}" data-title="添加类型" href="javascript:;">添加类型</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="{{url('admin/foods/create')}}" data-title="添加商品" href="javascript:;">添加商品</a></li>
					<li><a data-href="{{url('admin/foods')}}" data-title="商品列表" href="javascript:;">商品列表</a></li>

					<li><a data-href="{{url('admin/taocan/create')}}" data-title="添加套餐" href="javascript:;">添加套餐</a></li>
					<li><a data-href="{{url('admin/taocan')}}" data-title="套餐列表" href="javascript:;">套餐列表</a></li>
			</ul>
		</dd>
	</dl>
	<!-- 权限的管理以及角色的管理 -->

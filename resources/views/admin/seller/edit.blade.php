      ...
      <tbody>
        <tr>
          <th width="100" class="text-r"><span class="c-red">*</span> 用户名：</th>
            <td><input readonly type="text" style="width:200px" class="input-text" value="{{$seller->seller_name}}" placeholder="请输入用户名" id="seller-name" name="seller_name" datatype="*2-16" nullmsg="用户名不能为空">* 只读 </td> 
          </tr>
         
          <tr>
            <th class="text-r"><span class="c-red">*</span> 手机：</th>
            <td><input type="text" style="width:300px" class="input-text" value="{{$seller->seller_tell}}" placeholder="" id="user-tel" name="seller_tell"></td>
          </tr>
          <tr>
            <th class="text-r">邮箱：</th>
            <td><input type="text" style="width:300px" class="input-text" value="{{$seller->seller_email}}" placeholder="" id="seller-email" name="seller_email"></td>
          </tr>

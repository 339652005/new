 ...
 @foreach($taocan as $k=>$v)
      <tr class="text-c">
        ...
        <td class="f-14 user-manage">
         ...
         <a title="编辑" href="{{url('admin/taocan/'.$v->taocan_id.'/edit')}}" onclick="user_edit('4','550','','编辑','user-add.html')" class="ml-5" style="text-decoration:none"><span class="label label-success">编辑</span><i class="icon-edit"></i></a> 

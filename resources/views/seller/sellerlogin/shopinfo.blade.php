...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">店铺管理</a> &raquo; 更新信息
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form id="art_form" action="{{url('seller/changeShopinfo/'.$shop->shop_id)}}" method="post" enctype="multipart/form-data">
            <table class="add_tab">
                <tbody>
                   <!--  <tr>
   ...
   <p><img id="img_licence" src="/{{$shop->shop_licence}}" alt="上传后显示图片"  style="max-width:350px;max-height:100px;" /></p>
       ...
       <tr>
                    ...
                    @if($shop->shop_status=='1')
                             <label for=""><input type="radio" name="shop_status" value="1" checked>正在营业</label>
                             <label for=""><input type="radio" name="shop_status" value="2" >休息时间</label>
                    ...
                    <tr>
                       ...
                       <!--  <input type="hidden" name="_method" value="put"> -->
                            ...
                            <a href="{{url('seller/welcome')}}"><input type="button" class="back" onclick="history.go(-1)" value="返回"></a>
                        </td>
                    </tr>
                </tbody>
            </table>

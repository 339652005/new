...
<div class="pd-20">
  <div class="Huiform">
    <form action="{{url('seller/doreg')}}" method="post">
      ...
      <!-- //3.模板中数据 -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input type="text" style="width:300px" class="input-text" value="17681278236" placeholder="" id="user-tel" name="seller_tell"></td>
          </tr>
          <tr>
            <th class="text-r">邮箱：</th>
            <td><input type="text" style="width:300px" class="input-text" value="339652005@qq.com" placeholder="" id="user-email" name="seller_email"></td>
          </tr>
          <!-- <tr>

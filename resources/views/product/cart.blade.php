...
<nav class="navbar navbar-default  " role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">Laravel 商店首页
        ...
        <div class="col-sm-12 col-md-10 col-md-offset-1">
          ...
          @foreach( $carts as $cart)
                ...
                <tr>
                    ...
                    <!-- 移除数据 -->
                        <a href="/home/removecart/{{$cart->rowId}}"> <button type="button" class="btn btn-danger">
  ...
  @endforeach
                ...
                <tr>
                    ...
                    <!-- 继续 -->
                        ...
                        <!-- 情空 -->
                    <td>   <a href="/home/del"> <button type="button" class="btn  btn-danger">

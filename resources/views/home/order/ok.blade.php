    	...
    	<ul class="fr">
			...
			<li class="fore3 dorpdown" id="ttbar-myjd">
				<div class="dt cw-icon">
					...
					<a target="_blank" href="http://home.jd.com/">我的</a>
				</div>
			...
			<li class="fore4">
				<div class="dt">
					<a target="_blank" href="http://vip.jd.com/">会员</a>
				</div>
			</li>
			<li class="spacer"></li>
			<li class="fore5">
			...
			<li class="fore6 dorpdown" id="ttbar-apps" aid="2_955_6342">
				<div class="dt cw-icon">
					<i class="ci-left"></i>
					<i class="ci-right"><s>◇</s></i>
					<a target="_blank" href="http://app.jd.com/">手机</a>
				</div>
...
<div class="w w1 header clearfix">
	<div id="logo">
		...
		<img src="./public/images/logo-201305.png" alt="">
		</a>
...
<div id="container">
    ...
    <div class="btn-area mb10">
        <a class="btn-ordershow" href="{{url('home/detail')}}">查看订单</a>
                    <a class="btn-buyagain ml10" href="{{url('home/index')}}" clstag="pageclick|keycount|trade_201602181|32">
                <i></i>
                            再次购买
            </a>
            </div>
		    						    ...
		    						    <ul class="list-order">
			    					<li class="li-st">
					<div class="fore1">订单号：<a href="">
					<?php
					if ($request->session()->has('order_id')) {
						# code...
						echo $request->session('order_id');
					}
		
					?></a></div>
					<!-- 货到付款 -->
										   <div class="fore2">货到付款：<strong class="ftx-01">

										   <?php

					if ($request->session()->has('order_total')) {
						# code...
						echo $request->session('order_total');
					}
        ...
        <div class="d-tips">
    		...
    		<div class="qr-code"><a class="code" href="javascript:void(0)"><img alt="" src="./public/images/5435f1eeNc4bfcf9e.jpg"></a><a class="sao02" href="javascript:void(0)"></a></div>
    	</div>
    	<div class="o-mb">完成支付后，您可以：
    	 ...
    	 <span class="jl-jingdou">
            <a href="http://vip.jd.com/help_beansIntroduction.html" class="jl-la" style="color:#7ABD54;" target="_blank">完成订单有机会奖励</a> | 使用更超值，请登录<a href="http://vip.jd.com/" target="_blank">会员俱乐部</a>
          </span>
    	</div>
    </div>
